        ...
        <div className='max-w-7xl w-full mx-auto relative h-full'>
                    ...
                    <div className='absolute -bottom-[50%] left-1/2 transform -translate-x-1/2 w-full max-w-5xl px-4 py-4'>
                        <div className='w-full h-full px-8 pt-10 flex lg:flex-row flex-col items-center justify-between gap-10'>
                            <div className='w-full sm:w-[24rem] relative'>
                                <img src="footerModel.png" className='w-[20rem] object-contain'/>
                                <div className='h-full xs:h-[18rem] w-full bg-yellow-400 rounded-3xl rotate-12 -z-1 absolute -top-[10%] '>
                                </div>
                                <div className='h-full xs:h-[18rem] w-full bg-blue-400 rounded-3xl -rotate-12 -z-2 absolute -top-[10%]'>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className='grid md:grid-cols-2 grid-cols-1 gap-4 my-8 py-8'>
                    <div className='flex flex-col items-start justify-start gap-4 px-10'>
                        <div className='text-xl font-extrabold tracking-wider uppercase text-pretty leading-relaxed'>
